...
<div class="wrap clearfix">
	...
	<div class="mainbox">
		...
		<div class="order-search clearfix">
			<div class="y">
			<FORM name="order-form" id="orderForm" method="get" action="/order/items/<{$status}>">
			<input type="text" name="k" class="txt" value="<{$smarty.get.k}>" size="30" /><a href="javascript:;" class="btn btn-order-search" onclick="$('#orderForm').submit();">搜 索</a>
			</FORM>
			</div>
