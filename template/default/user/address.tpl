...
<div class="breadcrumb wrap">
	<a href="/">首页</a><span>&gt;</span><a href="/user">会员中心</a><span>&gt;</span><a href="/user/address">收货地址</a>
</div>
	...
	<div class="mainbox">
		<{if $address_data}>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl tbl-border">
              ...
              <tr>
                <td class="ltd"></td>
                <td><input type="submit" name="submit" class="btn2" value="提 交" />
