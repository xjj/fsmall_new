...
<div class="admin-wrap">
	...
	<hr class="line" />
	<form name="form" method="post" action="/<{$mod}>/<{$col}>/cat/edit/<{$cat_data.cat_id}>">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl2">
	  <tr>
		...
		<td><input type="text" name="cat_name" size="20" class="txt" value="<{$cat_data.cat_name}>"/></td>
	  </tr>
	  <tr>
		<td class="ltd">排序</td>
		<td height=""><input type="text" name="sort" size="5" class="txt" value="<{$cat_data.displayorder}>" /></td>
	  </tr>
