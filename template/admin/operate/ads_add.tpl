...
<div class="admin-wrap">
	...
	<form name="form" method="post" action="/<{$mod}>/<{$col}>/ads/<{$adp_data.adp_id}>/add">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl2">
	  <tr>
		...
		<td><input type="text" name="pic" class="txt txt2" size="50" readonly="readonly" id="form-pic" />
	  ...
	  <tr>
		<td class="ltd">标题</td>
		<td><input type="text" name="title" class="txt" size="50" />
		</td>
	  </tr>
	  <tr>
